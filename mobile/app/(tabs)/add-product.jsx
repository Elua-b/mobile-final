        ...
        <SafeAreaView className="p-4 h-full justify-center bg-blue-500 ">
            <View className='FLEX justify-center items-center'>
             {/* add  icon */}
                ...
                <Text className="text-xl font-semibold text-white ">Add Product</Text>
                <Text className="text-gray-600 text-base">Please  add a new product</Text>
            </View>
            <View className="mb-5 mt-8 p-7">
                <CustomInput
                    value={formData.name}
                    label="Product Name"
