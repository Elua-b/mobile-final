  ...
  return (
    ...
    >
      <FlatList
        ...
        renderItem={({ item }) => (
          <View className='p-3  rounded-lg mb-3 border border-gray-200 bg-blue-500 shadow-sm'>
        ...
        ListHeaderComponent={() => (
          <View className='mb-6 flex justify-center items-center '>
            <Text className='text-xl text-gray-800 font-rubiksemibold'>Welcome,<Text className='mr-4 text-blue-300'>{user?.name}</Text> </Text>
